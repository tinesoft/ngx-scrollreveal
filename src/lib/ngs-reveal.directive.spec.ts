...
import { NgbTabsetConfig } from '../../../ngs-reveal-config';
...
describe('ngb-tabset', () => {
    beforeEach(
        () => { TestBed.configureTestingModule({ declarations: [TestComponent], imports: [NgsRevealModule.forRoot()] }); });
    ...
    describe('Custom config', () => {
        ...
        beforeEach(() => { TestBed.configureTestingModule({ imports: [NgsRevealModule.forRoot()] }); });
    ...
    describe('Custom config as provider', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule(
                { imports: [NgsRevealModule.forRoot()], providers: [{ provide: NgbTabsetConfig, useValue: config }] });
        });
